...
class PortfolioRepositoryAdapter(
    ...
    override fun findPortfolioSummariesByOrganization(organizationId: Long): Flux<PortfolioSummary> {
        return portfolioJpaRepository.findByOrganizationId(organizationId)
            ...
            .onErrorMap { e -> RuntimeException("Error finding portfolio summaries for organization $organizationId", e) }
    }
     ...
     */
    override fun searchPortfolios(name: String?, type: PortfolioType?, status: PortfolioStatus?, organizationId: Long?): Flux<PortfolioSummary> {
