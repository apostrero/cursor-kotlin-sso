...
interface EventStore {
     ...
     */
    fun save(event: com.company.techportfolio.shared.domain.event.DomainEvent): Mono<Void>
     ...
     */
    fun saveAll(events: List<com.company.techportfolio.shared.domain.event.DomainEvent>): Mono<Void>
     ...
     */
    fun getEvents(aggregateId: String): Mono<List<com.company.techportfolio.shared.domain.event.DomainEvent>>
     ...
     */
    fun getEventsByType(eventType: String): Mono<List<com.company.techportfolio.shared.domain.event.DomainEvent>>
} 